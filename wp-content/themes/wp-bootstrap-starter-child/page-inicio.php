                ...
                <div class="col-12">
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="col-lg-2 d-flex justify-content-center my-4 px-0">
                            ...
                            <a 
                            class="l-news__btn-new w-100 u-line-height-100 u-border-2 u-border-color-theme d-block u-font-weight-bold text-center text-uppercase text-decoration-none u-color-folk-theme hover:u-color-folk-white u-bg-folk-none hover:u-bg-folk-theme p-3 aos-init" 
                            href="<?php echo $link_pattern . 'noticias/?cat=61'?>" 
                            data-aos="zoom-in">
                                + Notícias
                            </a>
                        </div>
